...
contains
   subroutine set_rates( rxt_rates, sol, ncol )
      ...
      rxt_rates(:ncol,:,     8) = rxt_rates(:ncol,:,     8)*sol(:ncol,:,    38)                                                ! rate_const*O3*monoterp
      rxt_rates(:ncol,:,     9) = rxt_rates(:ncol,:,     9)*sol(:ncol,:,    38)                                                ! rate_const*OH*monoterp
      rxt_rates(:ncol,:,    10) = rxt_rates(:ncol,:,    10)*sol(:ncol,:,    38)                                                ! rate_const*NO3*monoterp
      rxt_rates(:ncol,:,    11) = rxt_rates(:ncol,:,    11)*sol(:ncol,:,    39)                                                ! rate_const*O3*isoprene
      rxt_rates(:ncol,:,    12) = rxt_rates(:ncol,:,    12)*sol(:ncol,:,    39)                                                ! rate_const*OH*isoprene
      rxt_rates(:ncol,:,    13) = rxt_rates(:ncol,:,    13)*sol(:ncol,:,    39)                                                ! rate_const*NO3*isoprene

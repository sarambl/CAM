...
!-------------------------------------------------------
      ...
      rate(:,459) = 1.4e-11_r8
      rate(:,462) = 1.9e-12_r8
      rate(:,477) = 6.34e-08_r8
      rate(:,500) = 1.29e-07_r8
      rate(:,501) = 2.31e-07_r8
      rate(:,502) = 2.31e-06_r8
      rate(:,503) = 4.63e-07_r8
      ...
      rate(:,454) = 2.3e-12_r8 * exp_fac(:)
      rate(:,455) = 1.2e-11_r8 * exp_fac(:)
      rate(:,456) = 5.7e-11_r8 * exp_fac(:)
      rate(:,457) = 2.8e-11_r8 * exp_fac(:)
      rate(:,458) = 6.6e-11_r8 * exp_fac(:)
      rate(:,459) = 1.4e-11_r8 * exp_fac(:)
      rate(:,462) = 1.9e-12_r8 * exp_fac(:)
      rate(:,477) = 6.34e-08_r8 * exp_fac(:)
      rate(:,500) = 1.29e-07_r8 * exp_fac(:)
      rate(:,501) = 2.31e-07_r8 * exp_fac(:)
      rate(:,502) = 2.31e-06_r8 * exp_fac(:)
      rate(:,503) = 4.63e-07_r8 * exp_fac(:)
      ...
      rate(:,279) = 4.63e-12_r8 * exp( 350._r8 * itemp(:) )
      ...
      rate(:,419) = 1.7e-12_r8 * exp( 352._r8 * itemp(:) )
      exp_fac(:) = exp( 490._r8 * itemp(:) )
      rate(:,432) = 1.2e-12_r8 * exp_fac(:)
      rate(:,506) = 1.2e-12_r8 * exp_fac(:)
      exp_fac(:) = exp( -580._r8 * itemp(:) )
      rate(:,433) = 6.3e-16_r8 * exp_fac(:)
      rate(:,504) = 6.3e-16_r8 * exp_fac(:)
      exp_fac(:) = exp( 440._r8 * itemp(:) )
      rate(:,434) = 1.2e-11_r8 * exp_fac(:)
      rate(:,505) = 1.2e-11_r8 * exp_fac(:)
      rate(:,452) = 2.1e-11_r8 * exp( -2200._r8 * itemp(:) )
      rate(:,453) = 7.2e-14_r8 * exp( -1070._r8 * itemp(:) )
      rate(:,460) = 1.6e-13_r8 * exp( -2280._r8 * itemp(:) )
      rate(:,463) = 2.7e-11_r8 * exp( 335._r8 * itemp(:) )
      rate(:,466) = 1.9e-13_r8 * exp( 520._r8 * itemp(:) )
      rate(:,467) = 9.6e-12_r8 * exp( -234._r8 * itemp(:) )
      rate(:,468) = 1.7e-12_r8 * exp( -710._r8 * itemp(:) )
